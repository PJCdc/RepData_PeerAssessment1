...
```
    ...
    Mean total number of steps taken per day - adjusted data set - is `r mean(steps.date.total$Total.Steps, na.rm = TRUE)`
...
```
    ...
    Median total number of steps taken per day - adjusted data set - is `r median(steps.date.total$Total.Steps, na.rm = TRUE)`
