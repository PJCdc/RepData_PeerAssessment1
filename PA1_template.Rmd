...
```
    ...
    Mean total number of steps taken per day is `r mean(steps.date.total$Total.Steps, na.rm = TRUE)`
...
```
    ...
    Median total number of steps taken per day is `r median(steps.date.total$Total.Steps, na.rm = TRUE)`
...
The number of missing values in the steps variable is `r sum(is.na(activity.data.raw$steps))`
...
```
    ...
    Mean total number of steps taken per day - adjusted data set - is `r mean(adjustedSteps.date.total$Total.Steps, na.rm = TRUE)`
...
```
    ...
    Median total number of steps taken per day - adjusted data set - is `r median(adjustedSteps.date.total$Total.Steps, na.rm = TRUE)`
...
- Mean total number of steps taken per day - original data set - is `r mean(steps.date.total$Total.Steps, na.rm = TRUE)`

- Median total number of steps taken per day - original data set - is `r median(steps.date.total$Total.Steps, na.rm = TRUE)`
